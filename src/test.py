...
class TestDATA():
    ...
    def test_pivots(self):
        ...
        Testing for pivots
        """
        assert_equal(self.D.pivots, ["likes", "hates", "john"])
    ...
    def test_source_nonpivots(self):
        ...
        """
        assert_equal(self.D.source_specific_feats, ["apples", "red"])
    ...
    def test_target_nonpivots(self):
        ...
        """
        assert_equal(self.D.target_specific_feats, ["bananas", "simon"])
    ...
    def test_source_feat_space(self): 
        ...
        """
        assert_equal(self.D.src_feats, ['apples', 'likes', 'john', 'are', 'david', 'hates', 'red'])
    ...
    def test_XlA_neg(self):
        ...
        XlA_neg = numpy.array([[1,0,0,0,1,1,0]])
